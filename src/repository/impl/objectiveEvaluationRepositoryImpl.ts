...
import { ObjectiveEvaluationRepository } from "../objectiveEvaluationRepository";
import { ObjectiveEvaluationModel } from "../models/objectiveEvaluationModel";

export class PgObjectiveEvaluationRepository implements ObjectiveEvaluationRepository {
